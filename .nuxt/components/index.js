...
export { default as Contacts } from '../..\\components\\layouts\\Contacts.vue'
export { default as Delivery } from '../..\\components\\layouts\\Delivery.vue'
...
export const LazyProductsList = import('../..\\components\\products-list\\ProductsList.vue' /* webpackChunkName: "components/products-list" */).then(c => c.default || c)
export const LazyProductsListFilter = import('../..\\components\\products-list\\ProductsListFilter.vue' /* webpackChunkName: "components/products-list-filter" */).then(c => c.default || c)
...
export const LazyContacts = import('../..\\components\\layouts\\Contacts.vue' /* webpackChunkName: "components/contacts" */).then(c => c.default || c)
export const LazyDelivery = import('../..\\components\\layouts\\Delivery.vue' /* webpackChunkName: "components/delivery" */).then(c => c.default || c)
